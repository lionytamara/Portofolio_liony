...
export const CertificatesSection: React.FC = () => {
  ...
  return (
    <section id="certificates" className="py-24 relative bg-slate-900/40">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {certificatesData.map((cert) => (
            <div
              ...
              className="glass-card rounded-2xl overflow-hidden border border-slate-800/80 hover:border-purple-500/50 transition-all duration-300 flex flex-col group cursor-pointer hover:-translate-y-2"
            >
              {/* Image Preview */}
              <div className="relative h-40 overflow-hidden bg-slate-950">
                ...
                <div className="absolute top-3 left-3 p-2 rounded-xl bg-slate-950/80 backdrop-blur-md border border-slate-800 text-purple-400">
              ...
              <div className="p-5 flex-1 flex flex-col justify-between">
                <div>
                  ...
                  <h3 className="text-sm font-bold text-slate-100 mt-1 mb-2 group-hover:text-purple-300 transition-colors line-clamp-2">
                    {cert.title}
                  </h3>
            ...
            <div className="flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="p-3 rounded-lg bg-slate-900 border border-slate-800 text-xs font-mono text-slate-300 mb-4">
                  Credential ID: <span className="text-blue-400">{selectedCert.credentialId}</span>
                </div>
                ...
                <a
                  ...
                  className="w-full inline-flex items-center justify-center gap-2 py-3 rounded-xl bg-purple-600 hover:bg-purple-500 text-white font-bold text-xs shadow-md"
                >
