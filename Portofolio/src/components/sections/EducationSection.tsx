    ...
    <section id="education" className="py-24 relative bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="Formal computer science education background, GPA score, and student organization contributions."
        />
        ...
        <div className="max-w-4xl mx-auto glass-card p-6 sm:p-10 rounded-3xl border border-slate-800 relative overflow-hidden">
          ...
          <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 pb-8 border-b border-slate-800">
            <div className="flex items-start gap-4">
              <div className="w-14 h-14 rounded-2xl bg-gradient-to-tr from-blue-600 to-purple-600 p-[1px] shrink-0">
