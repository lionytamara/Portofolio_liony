    ...
    <section id="experience" className="py-24 relative bg-slate-900/50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="Track record of bootcamps, freelance client contracts, campus projects, and leadership roles."
        />

        {/* Timeline Container */}
        <div className="relative max-w-4xl mx-auto mt-12">
          {/* Vertical Center Line */}
          <div className="absolute left-4 sm:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-600 via-purple-600 to-cyan-400 -translate-x-1/2 opacity-40" />
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute left-4 sm:left-1/2 top-0 -translate-x-1/2 z-10">
                    <div className="w-8 h-8 rounded-full bg-slate-950 border-2 border-blue-500 flex items-center justify-center shadow-lg shadow-blue-500/30">
                  ...
                  <div className="ml-12 sm:ml-0 sm:w-1/2 sm:px-8 w-full">
                    <div className="glass-card p-6 rounded-2xl border border-slate-800/80 hover:border-blue-500/40 transition-all duration-300 group">
