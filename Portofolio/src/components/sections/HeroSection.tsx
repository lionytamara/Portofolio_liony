...
export const HeroSection: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 right-1/4 w-[350px] h-[350px] bg-cyan-500/10 rounded-full blur-[100px] pointer-events-none" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full">
        <div className="flex flex-col lg:flex-row items-center justify-between gap-12 lg:gap-8">
          ...
          <div className="flex-1 text-center lg:text-left flex flex-col items-center lg:items-start">
            ...
            {/* Status Pill Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-500/10 border border-emerald-500/20 text-emerald-400 text-xs sm:text-sm font-semibold mb-6 shadow-sm shadow-emerald-500/10">
            ...
            <div className="h-12 sm:h-14 flex items-center justify-center lg:justify-start mb-6">
              <div className="flex items-center gap-2 text-xl sm:text-2xl font-bold text-slate-200">
                ...
                <span className="w-0.5 h-6 bg-cyan-400 animate-pulse ml-0.5" />
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 mb-10 w-full sm:w-auto">
              <button
                ...
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold text-sm shadow-xl shadow-blue-600/30 hover:shadow-blue-600/50 hover:scale-105 transition-all duration-300"
              >
              ...
              <a
                href="#contact"
                className="w-full sm:w-auto inline-flex items-center justify-center gap-2 px-7 py-3.5 rounded-xl bg-slate-900 border border-slate-700/80 text-slate-200 hover:text-white hover:bg-slate-800 hover:border-slate-600 font-bold text-sm transition-all duration-300"
              >
            ...
            <div className="flex items-center gap-4">
              ...
              <div className="flex items-center gap-2">
                <a
                  ...
                  className="p-2.5 rounded-xl bg-slate-900/80 border border-slate-800 text-slate-400 hover:text-white hover:border-blue-500/50 hover:scale-110 transition-all"
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2.5 rounded-xl bg-slate-900/80 border border-slate-800 text-slate-400 hover:text-blue-400 hover:border-blue-500/50 hover:scale-110 transition-all"
          ...
          <div className="relative flex items-center justify-center">
            ...
            <div className="absolute w-[320px] h-[320px] sm:w-[400px] sm:h-[400px] rounded-full bg-gradient-to-tr from-blue-600 via-purple-600 to-cyan-400 opacity-30 blur-xl animate-pulse-slow" />
            
            <div className="relative p-2 rounded-full bg-gradient-to-tr from-blue-600 via-purple-600 to-cyan-400 shadow-2xl shadow-blue-500/30">
              <div className="w-[280px] h-[280px] sm:w-[350px] sm:h-[350px] rounded-full overflow-hidden border-4 border-slate-950 bg-slate-900">
                <img
            ...
            <div className="absolute -bottom-6 -right-2 sm:bottom-4 sm:-right-6 glass-card px-4 py-2.5 rounded-2xl border border-slate-700/80 shadow-xl flex items-center gap-3 animate-float" style={{ animationDelay: '2s' }}>
              ...
              <div className="flex flex-col">
                <span className="text-xs font-bold text-white">GPA 3.20 / 4.00</span>
        ...
        <div className="mt-16 sm:mt-24 flex justify-center">
          <a
            href="#about"
            className="flex flex-col items-center gap-2 text-xs text-slate-500 hover:text-blue-400 transition-colors"
          >
