    ...
    <section id="projects" className="py-24 relative bg-slate-950">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          subtitle="Explore selected applications demonstrating clean code, modern UX aesthetics, and scalable front-end engineering."
        />
        ...
        <div className="flex justify-center gap-3 mb-12">
          {(
            ...
            <button
              ...
              className={`px-5 py-2 text-xs sm:text-sm font-semibold rounded-xl transition-all duration-200 border ${
                activeFilter === tab.id
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {filteredProjects.map((project) => (
            <div
              key={project.id}
              className="glass-card rounded-2xl overflow-hidden border border-slate-800/80 hover:border-blue-500/50 transition-all duration-300 flex flex-col group hover:-translate-y-2 hover:shadow-2xl hover:shadow-blue-500/10"
            >
              ...
              <div className="relative h-48 sm:h-52 overflow-hidden bg-slate-900">
                ...
                {project.featured && (
                  <div className="absolute top-3 left-3 flex items-center gap-1 px-2.5 py-1 rounded-full bg-blue-600/90 text-white text-[10px] font-bold shadow-md">
                ...
                <div className="absolute inset-0 flex items-center justify-center gap-3 opacity-0 group-hover:opacity-100 bg-slate-950/60 backdrop-blur-xs transition-opacity duration-300">
                  <button
                    onClick={() => setSelectedProject(project)}
                    className="p-3 rounded-xl bg-blue-600 text-white hover:bg-blue-500 transition-colors shadow-lg"
                    title="View Details"
                  >
        ...
        >
          {selectedProject && (
            <div className="flex flex-col gap-6">
              ...
              <div>
                <h4 className="text-xs uppercase tracking-wider font-semibold text-blue-400 mb-1">
                ...
                {selectedProject.metrics && (
                  <div className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/20 text-xs font-semibold text-blue-300 mb-4">
                ...
                <div className="flex items-center gap-4 pt-4 border-t border-slate-800">
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex-1 inline-flex items-center justify-center gap-2 py-3 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-bold text-xs shadow-md"
                  >
