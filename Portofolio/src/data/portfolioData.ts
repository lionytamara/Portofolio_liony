...
export const personalInfo: PersonalInfo = {
  ...
  avatarUrl: '/DSC_6229.JPG.jpeg',
  resumeUrl: '/CV_Liony Tamara Lewinsky.pdf',
...
export const projectsData: ProjectItem[] = [
  ...
  {
    id: 'finova-digital-banking',
    title: 'Finova - Digital Banking & Fintech App',
    category: 'frontend',
    shortDescription: 'Next-generation web banking dashboard with instant peer-to-peer transfers, fraud detection alerts, and card management.',
    fullDescription: 'Finova redefines personal finance management with a frictionless user interface. Features virtual card generator, transaction category breakdowns, savings goals tracker, and automated currency converter.',
    thumbnail: 'https://images.unsplash.com/photo-1563986768609-322da13575f3?auto=format&fit=crop&w=800&q=80',
    tags: ['React', 'TypeScript', 'Tailwind CSS', 'Framer Motion', 'Lucide Icons'],
    githubUrl: 'https://github.com',
    liveUrl: 'https://example.com',
    role: 'UI/UX & Front-End Developer',
    metrics: 'Implemented over 15 dynamic micro-animations',
    features: [
      'Virtual Credit Card interactive flip animation',
      'Instant search and tag filtering for monthly transactions',
      'Interactive budget goal sliders with live calculation',
      'Security alert notification center',
    ],
    featured: true,
  },
  {
    id: 'omniflow-automation',
    title: 'OmniFlow - Visual AI Workflow Automation',
    category: 'fullstack',
    shortDescription: 'Node-based drag-and-drop flow builder enabling automated API trigger integration for modern software teams.',
    fullDescription: 'OmniFlow offers an intuitive canvas interface allowing users to connect webhooks, AI prompts, database queries, and notifications into automated workflow pipelines without writing code.',
    thumbnail: 'https://images.unsplash.com/photo-1507238691740-187a5b1d37b8?auto=format&fit=crop&w=800&q=80',
    tags: ['Next.js', 'React Flow', 'Node.js', 'Tailwind CSS', 'Zustand'],
    githubUrl: 'https://github.com',
    liveUrl: 'https://example.com',
    role: 'Full-Stack Developer',
    metrics: 'Supports up to 500+ canvas nodes without frame drops',
    features: [
      'Interactive canvas zoom, pan, and snap-to-grid controls',
      'Custom node configuration inspector drawer',
      'JSON export & import for pipeline sharing',
      'Pre-built templates for Slack, Email, and Webhook integrations',
    ],
    featured: true,
  },
  {
    id: 'shopsphere-ecommerce',
    title: 'ShopSphere - Headless E-Commerce Engine',
    category: 'fullstack',
    shortDescription: 'High-speed headless e-commerce store with optimistic shopping cart state, search auto-complete, and checkout flow.',
    fullDescription: 'Built with Next.js App Router and Tailwind CSS, ShopSphere delivers instant page transitions, server-side rendered catalog pages, multi-currency toggles, and seamless product filtering.',
    ...
    metrics: 'Sub-100ms client navigation speed',
    features: [
      'Instant slide-over shopping cart drawer',
      'Multi-filter catalog by price range, brand, and rating',
      'Product image gallery slider with zoom functionality',
  ...
  {
    id: 'taskcraft-kanban',
    title: 'TaskCraft - Agile Kanban Collaboration Suite',
    category: 'frontend',
    shortDescription: 'Interactive project management app featuring smooth drag-and-drop boards, task priority labels, and team metrics.',
    fullDescription: 'TaskCraft enhances team productivity by streamlining task allocation. Includes customizable swimlanes, subtask checklists, deadline countdown timers, and team member workload charts.',
    thumbnail: 'https://images.unsplash.com/photo-1618401471353-b98aedd04e11?auto=format&fit=crop&w=800&q=80',
    tags: ['React', 'TypeScript', 'dnd-kit', 'Tailwind CSS', 'Lucide Icons'],
    githubUrl: 'https://github.com',
    liveUrl: 'https://example.com',
    role: 'Frontend Developer',
    metrics: 'Zero-lag drag and drop interaction',
    features: [
      'Drag and drop tasks between Todo, In Progress, Review, and Done',
      'Search and filter tasks by team member or priority badge',
      'Subtask completion progress bar indicator',
  ...
  },
  {
    ...
    title: 'DevPulse - Developer Portfolio & Showcase Hub',
    category: 'fullstack',
    shortDescription: 'Social platform for tech talent to showcase open-source projects, receive peer code reviews, and earn badges.',
    fullDescription: 'DevPulse connects tech enthusiasts, student developers, and recruiters in an interactive space. Users can create custom developer profiles, post project write-ups, and receive community upvotes.',
    thumbnail: 'https://images.unsplash.com/photo-1522071820081-009f0129c71c?auto=format&fit=crop&w=800&q=80',
    tags: ['Next.js', 'React', 'MongoDB', 'Tailwind CSS', 'Express'],
    githubUrl: 'https://github.com',
    liveUrl: 'https://example.com',
    role: 'Full-Stack Developer',
    metrics: 'Built as Campus Capstone Project with distinction',
    features: [
      'Markdown project description editor with live preview',
      'Upvote and bookmark system for inspiration',
      'Developer tech stack match search filter',
      'Responsive comment thread with nested replies',
    ],
    featured: false,
  },
];
...
export const certificatesData: CertificateItem[] = [
  {
    ...
    skills: ['React', 'JavaScript', 'HTML/CSS', 'UX Principles', 'Version Control'],
  },
  {
    id: 'cert-2',
    ...
    issueDate: 'Nov 2025',
    credentialId: 'AWS-CCP-771920',
    credentialUrl: 'https://aws.amazon.com',
    image: 'https://images.unsplash.com/photo-1451187580459-43490279c0fa?auto=format&fit=crop&w=600&q=80',
    skills: ['Cloud Architecture', 'AWS S3', 'EC2 Basics', 'IAM Security', 'Serverless'],
  },
  {
    id: 'cert-3',
    ...
    issuer: 'Google',
    issueDate: 'Sep 2025',
    credentialId: 'GOOG-UX-448219',
    credentialUrl: 'https://coursera.org',
    image: 'https://images.unsplash.com/photo-1581291518633-83b4ebd1d83e?auto=format&fit=crop&w=600&q=80',
    skills: ['Wireframing', 'Prototyping', 'Figma', 'Usability Testing', 'Design Systems'],
  },
  {
    id: 'cert-4',
    title: 'Expert Front-End Web Developer Certification',
    issuer: 'Dicoding Indonesia',
    issueDate: 'Jul 2025',
    credentialId: 'DICODING-FE-331092',
    credentialUrl: 'https://dicoding.com',
    image: 'https://images.unsplash.com/photo-1526374965328-7f61d4dc18c5?auto=format&fit=crop&w=600&q=80',
    skills: ['Web Performance', 'PWA', 'Clean Code', 'Automation Testing', 'Accessibility'],
  },
];
