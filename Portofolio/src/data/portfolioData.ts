...
export const personalInfo: PersonalInfo = {
  ...
  // Wajib menggunakan /Portofolio_liony karena dipanggil menggunakan tag <img> standar
...
export const statItems: StatItem[] = [
  { label: 'Projects Built', value: '15+', subtext: 'Full-stack & Front-end Apps', icon: 'Code2' },
  { label: 'Tech Stack Skills', value: '20+', subtext: 'Tools & Frameworks', icon: 'Cpu' },
  { label: 'Certificates', value: '8+', subtext: 'Meta, Google & AWS Certified', icon: 'Award' },
  { label: 'GPA Score', value: '3.20', subtext: 'Scale 4.00', icon: 'GraduationCap' },
];

export const personalValues: PersonalValue[] = [
  { title: 'Business Analysis', description: 'Skilled in gathering requirements, analyzing business processes, and translating business needs into clear technical solutions.', icon: 'CheckCircle2' },
  { title: 'Data Analytics', description: 'Experienced in SQL, Excel, Power BI, and data visualization to support business decision-making.', icon: 'TrendingUp' },
  { title: 'Business Development', description: 'Passionate about identifying business opportunities, building strong client relationships, and delivering value-driven solutions to support business growth.', icon: 'Zap' },
  { title: 'Product Analysis', description: 'Experienced in analyzing user needs, gathering business requirements, and translating insights into product improvements that enhance user experience.', icon: 'Layout' },
];
...
export const skillsData: SkillItem[] = [
  ...
  { name: 'Data Preprocessing', level: 90, iconName: 'Zap', category: 'analytics', badgeText: 'Advanced' },
...
export const projectsData: ProjectItem[] = [
  ...
  },
  {
    ...
    fullDescription: 'A hybrid Text-to-SQL framework integrating Retrieval-Augmented Generation (RAG), an In-Context Reinforcement Learning (ICRL) process that runs completely offline during the preparation stage, and the SHARE framework positioned at the final stage of the pipeline architecture. This research proposes a hybrid framework that combines RAG to retrieve relevant schema and query examples, ICRL for offline preparation, and utilizes a small language model component as the final checker.',
    ...
    metrics: 'Evaluated on BIRD Development Set (Execution Accuracy)',
    features: [
      'Retrieval-Augmented Generation (RAG) to retrieve relevant schema and query examples',
      'In-Context Reinforcement Learning (ICRL) process that runs completely offline during the preparation stage',
      'SHARE framework positioned at the final stage of the pipeline architecture, utilizing a small language model component as the final checker',
      'Evaluation on BIRD Development Set using EX (Execution Accuracy) and Error Distribution',
    ],
    featured: true,
  },
  {
...
export const certificatesData: CertificateItem[] = [
  {
    ...
    // TANPA /Portofolio_liony untuk mencegah Double Path di Next.js Image Component
