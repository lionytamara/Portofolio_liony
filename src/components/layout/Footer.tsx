...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="relative bg-[#070c18] border-t border-slate-800/80 pt-16 pb-12 overflow-hidden">
      {/* Top glowing ambient line */}
      <div className="absolute top-0 inset-x-0 h-[1px] bg-gradient-to-r from-transparent via-emerald-500 to-transparent opacity-50" />
          ...
          <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center gap-3">
              <a
                ...
                className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-400 hover:text-white hover:border-emerald-500/50 transition-all hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-400 hover:text-emerald-400 hover:border-emerald-500/50 transition-all hover:scale-110"
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="p-2.5 rounded-xl bg-slate-900 border border-slate-800 text-slate-400 hover:text-pink-400 hover:border-pink-500/50 transition-all hover:scale-110"
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-slate-500">
          <p className="flex items-center gap-1.5">
            ...
            <span className="flex items-center gap-1">
              Crafted with <Heart className="w-3 h-3 text-emerald-400 fill-emerald-400 inline" /> & Next.js
            </span>
          </p>
