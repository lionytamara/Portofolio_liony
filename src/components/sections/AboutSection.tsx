...
export const AboutSection: React.FC = () => {
  return (
    <section id="about" className="py-24 relative bg-[#070c18]/60">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-start mt-8">
          ...
          <div className="lg:col-span-7 flex flex-col gap-8">
            ...
            <div className="glass-card p-6 sm:p-8 rounded-2xl border border-slate-800 relative overflow-hidden">
              ...
              <p className="text-slate-300 text-base leading-relaxed mb-4">
                A driven Information Systems graduate from Del Institute of Technology with a strong interest in <strong className="text-emerald-400">Data Analytics, Business Analysis, Business Development</strong>, and <strong className="text-teal-300">Product Analysis</strong>. Passionate about leveraging data, understanding business needs, and developing strategic solutions that create value for users and support business growth.
              </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              {personalValues.map((val, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="glass-card p-5 rounded-xl border border-slate-800 hover:border-emerald-500/40 transition-all duration-200 group"
                  >
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="grid grid-cols-2 gap-4">
              {statItems.map((stat, idx) => {
                ...
                return (
                  <div
                    key={idx}
                    className="glass-card p-6 rounded-2xl border border-slate-800/80 text-center relative overflow-hidden group hover:border-emerald-500/40 transition-all"
                  >
                    <div className="w-12 h-12 rounded-xl bg-emerald-500/10 border border-emerald-500/20 mx-auto flex items-center justify-center text-emerald-400 mb-3 group-hover:scale-110 transition-transform">
            ...
            <div className="glass-card p-6 rounded-2xl border border-slate-800 bg-gradient-to-br from-slate-900 via-slate-900 to-emerald-950/30">
